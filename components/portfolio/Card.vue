    ...
    <div class="max-w-[720px] w-full mx-auto">
      ...
      <di v class="flex flex-col bg-lightPrimary dark:bg-darkPrimary shadow-lg bg-clip-border rounded-xl border border-solid border-primary dark:border-darkSecondary">
        ...
        <div class="flex justify-center pb-4">
          <button
            class="align-middle py-[0.30rem] px-3 rounded-lg font-bold text-center uppercase transition-all text-xs bg-primary text-darkPrimary  hover:bg-secondary hover:text-lightPrimary"
            type="button">
            Add to Cart
          </button>
        </div>
